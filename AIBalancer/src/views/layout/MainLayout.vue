  ...
  Select: {
    peers: {
      ...
      InternalSelectMenu: {
        ...
        optionColorPending: 'rgba(94, 114, 235, 0.15)',
        optionColorActive: 'rgba(94, 114, 235, 0.2)',
        optionColorSelected: 'rgba(94, 114, 235, 0.25)',
        optionColorSelectedPending: 'rgba(94, 114, 235, 0.3)',
        optionTextColor: 'rgba(255, 255, 255, 0.85)',
        optionTextColorActive: 'rgba(255, 255, 255, 0.95)',
        optionTextColorSelected: 'rgba(255, 255, 255, 0.95)',
        optionTextColorPending: 'rgba(255, 255, 255, 0.85)',
  ...
  Select: {
    peers: {
      ...
      InternalSelectMenu: {
        ...
        optionColorActive: 'rgba(94, 114, 235, 0.12)',
        optionColorSelected: 'rgba(94, 114, 235, 0.15)',
        optionColorSelectedPending: 'rgba(94, 114, 235, 0.2)',
        optionTextColor: 'rgba(0, 0, 0, 0.85)',
        optionTextColorActive: 'rgba(0, 0, 0, 0.95)',
        optionTextColorSelected: 'rgba(0, 0, 0, 0.95)',
        optionTextColorPending: 'rgba(0, 0, 0, 0.85)',
        optionCheckColor: '#5e72e4',
